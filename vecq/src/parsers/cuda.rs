...
impl CudaParser {
    ...
    fn process_nodes(&self, node: tree_sitter::Node, content: &str) -> Vec<DocumentElement> {
            ...
            if child.kind() == "function_declarator" {
                ...
                for decl_child in child.children(&mut decl_cursor) {
                    if decl_child.kind() == "identifier"
                        ...
                        || decl_child.kind() == "qualified_identifier"
                    {
                        name = decl_child
                            .utf8_text(content.as_bytes())
                            .unwrap_or("")
