            ...
            match kind {
                ...
                "struct_specifier" | "union_specifier" | "enum_specifier" => {
                    ...
                    let effective_type = match element_type {
                        ElementType::Union | ElementType::Enum | ElementType::Struct => {
                            element_type
                        }
                        _ => ElementType::Struct,
                    };
...
"#;
        ...
        let has_x = point
            .children
            .iter()
            .any(|c| c.name.as_deref() == Some("x") && c.element_type == ElementType::Variable);
        ...
        let has_meta = point
            .children
            .iter()
            .any(|c| c.name.as_deref() == Some("Meta") && c.element_type == ElementType::Struct);
