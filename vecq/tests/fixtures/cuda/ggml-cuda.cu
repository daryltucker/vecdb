...
struct ggml_cuda_pool_vmm : public ggml_cuda_pool {
    ...
    explicit ggml_cuda_pool_vmm(int device, bool alloc) :
        ...
        // >> Tesla K80
        {
            ...
            // The "Trick": max_pool_size is Virtual, not Physical.
            // set it to the full 32GB (CUDA_POOL_VMM_MAX_SIZE) to ensure it never assertions.
            // Physical protection is handled by the check at alloc time.
